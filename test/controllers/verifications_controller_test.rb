...
class VerificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create verification" do
    assert_difference('Verification.count') do
      post verifications_url, params: { verification: { email: @verification.email, first_name: @verification.first_name, last_name: @verification.last_name, name: @verification.name, phone: @verification.phone, statut: @verification.statut, user_id: @verification.user_id } }
    end
  ...
  test "should update verification" do
    patch verification_url(@verification), params: { verification: { email: @verification.email, first_name: @verification.first_name, last_name: @verification.last_name, name: @verification.name, phone: @verification.phone, statut: @verification.statut, user_id: @verification.user_id } }
